...
We have further more, notified some of the participants of our survey that answered they did not implement monitoring that they are welcome to try out our solution. We have not yet received any response from any of them. But this is an entrypoint for further research and discovery. How well does this solution work, and which factors decide if the solution will work or not.
